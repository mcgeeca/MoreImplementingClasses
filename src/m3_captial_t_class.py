...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        horizontal_rectangle_center = intersection_center
        h_corner_1_x = horizontal_rectangle_center.x - width / 2
        h_corner_1_y = horizontal_rectangle_center.y - letter_thickness / 2
        h_corner_1 = rg.Point(h_corner_1_x, h_corner_1_y)
        h_corner_2_x = horizontal_rectangle_center.x + width / 2
        h_corner_2_y = horizontal_rectangle_center.y + letter_thickness / 2
        h_corner_2 = rg.Point(h_corner_2_x, h_corner_2_y)
        self.h_rect = rg.Rectangle(h_corner_1, h_corner_2)
        v_corner_1_x = horizontal_rectangle_center.x - letter_thickness / 2
        v_corner_1_y = h_corner_1_y
        v_corner_1 = rg.Point(v_corner_1_x, v_corner_1_y)
        v_corner_2_x = horizontal_rectangle_center.x + letter_thickness / 2
        v_corner_2_y = v_corner_1_y + height
        v_corner_2 = rg.Point(v_corner_2_x, v_corner_2_y)
    ...
    def clone(self):
        ...
        height_2 = self.v_rect.get_height()
        center = self.h_rect.get_center()
        print(letter_thickness, width, height_2, center)
        new_capital_T = CapitalT(center, width, height_2, letter_thickness)
        new_capital_T.set_colors(self.h_rect.fill_color, self.h_rect.outline_color)
